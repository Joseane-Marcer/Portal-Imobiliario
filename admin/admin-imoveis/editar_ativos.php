...
<?php if(isset($_POST['executar']) && $_POST['executar'] == 'Editar Anúncio'){
...
try{
	...
	echo '<div class="ok">Edição Concluida</div>';
...
<input type="submit" name="executar" id="executar" value="Editar Anúncio" />
